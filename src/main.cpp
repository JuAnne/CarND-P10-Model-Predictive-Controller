      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // 3. Define initial state and calculate cross-track error and orientation error
          // The cross track error is calculated by evaluating at polynomial at x, f(x)
          // and subtracting y. 
          // x and y set to zero since it's calculated with respect to the first point
          ...
          // 4. Incorporate simulator delay and define state vector
          ...
          steer_value = -vars[0]; // reverse before sending back to the simulator
          throttle_value = vars[1];

          // 6. Send result back to simulator 
          json msgJson;
